...
<body>
    ...
    <div class="main">
        ...
        <div class="news" id="news">
            <h3 class="w3_head mb-4 text-left">My Work Experiences</h3>
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        ...
                        <div class="col-sm-6">
                           <asp:TextBox ID="TextBox2" runat="server" placeholder="Your Email Address"></asp:TextBox>
                        </div>
                    </div>
                    <asp:TextBox ID="TextBox3" runat="server" placeholder="Subject"></asp:TextBox>
                    <%--<textarea name="Message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message...';}" required="">Message...</textarea>--%>
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Your Message" TextMode="MultiLine" Height="50"></asp:TextBox>
                    <%--<button type="submit" class="btn">Send Message</button>--%>
                    <%--<button type="reset" class="btn">Reset</button>--%>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Text="Send" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-warning" Text="Give Up!" />
